...
export const createCube = () => {
  ...
  cube.onClick = () => {
    ...
    if (isClicked) {
      ...
      rotationSpeed = isHovered ? MathUtils.degToRad(60) : MathUtils.degToRad(30);
      (material as MeshStandardMaterial).color.setHex(isHovered ? hoverColor : originalColor);
      (material as MeshStandardMaterial).emissive.setHex(isHovered ? 0x222222 : 0x000000);
